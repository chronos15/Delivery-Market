...
class ProdutosSubGrupoWidget extends StatefulWidget {
  const ProdutosSubGrupoWidget({
    Key key,
    this.recebeSubgrupo,
  }) : super(key: key);

  final SubgrupoRecord recebeSubgrupo;

  @override
  _ProdutosSubGrupoWidgetState createState() => _ProdutosSubGrupoWidgetState();
}

class _ProdutosSubGrupoWidgetState extends State<ProdutosSubGrupoWidget> {
  CarrinhoRecord te;
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<ProdutosRecord>>(
      stream: queryProdutosRecord(
        queryBuilder: (produtosRecord) => produtosRecord.where('codsubgrupo',
            isEqualTo: widget.recebeSubgrupo.reference),
      ),
      builder: (context, snapshot) {
        ...
        List<ProdutosRecord> produtosSubGrupoProdutosRecordList = snapshot.data;
        return Title(
            title: 'ProdutosSubGrupo',
                                                    ...
                                                    onChanged: (_) =>
                                                      ...
                                                      () async {
                                                        setState(() {
                                                          simpleSearchResults =
                                                              TextSearch(
                                                            produtosSubGrupoProdutosRecordList
                                                                .map(
                                                                  (record) =>
                                                                      TextSearchItem(
                                                                          record,
                        ...
                        children: [
                          ...
                          if (!FFAppState().textocompleto)
                            Padding(
                              ...
                              child: Builder(
                                builder: (context) {
                                  final pesquisaprod = simpleSearchResults
                                      .map((e) => e)
                                      .toList();
                                  return ListView.builder(
                                    ...
                                    itemBuilder: (context, pesquisaprodIndex) {
